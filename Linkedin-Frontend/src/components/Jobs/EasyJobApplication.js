...
class EasyJobApplication extends Component{
    constructor(props){
        super(props);
        console.log(props);
        this.state={
                        ...
                        <div className="form-container mt-5 border">
                            <div className="ml-5 mt-3 form-content">
                                ...
                                <div className="form-group">
                                    <input type="text" value = {this.state.profile.Fname} name="firstname" className="form-control form-control-lg" onChange={this.handleChange} required placeholder="First Name"/>
                                </div>
                                <div className="form-group">
                                    <input type="text"  value = {this.state.profile.Lname} name="lastname" className="form-control form-control-lg" onChange={this.handleChange} required placeholder="Last Name"/>
                                </div>
                                <div className="form-group">
                                    <input type="text"  value = {this.state.profile.email} name="email" className="form-control form-control-lg" placeholder="Email" onChange={this.handleChange} required/>
                                </div>
                                <div className="form-group">
...
export default connect(mapStateToProps)(EasyJobApplication);